...
export class StatusController {
  ...
  @ApiResponse({
    ...
    description:
      ...
      'Baileys, the status was not posted by this session in the last 24 hours (or was posted before a ' +
      'restart, from the phone or from another node), so its recipients are unknown and the revoke cannot ' +
