...
- The dashboard Chats thread renders an `@<digits>` mention as `@FirstName` when that participant has posted in the loaded thread; an unmatched mention is left as WhatsApp sent it.
