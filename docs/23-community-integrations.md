...
| **n8n to Discord**  | [n8n](https://n8n.io/) (workflow automation)                  | [docs/examples/n8n](./examples/n8n)                                                                                                            | A minimal workflow template to receive OpenWA webhooks and post incoming messages to a Discord channel using built-in n8n HTTP nodes.  |
