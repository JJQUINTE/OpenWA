...
class OpenWARateLimitError(OpenWAApiError):
    ...
    The global rate limiter's 429 clears within seconds; its delay is only in the Retry-After
    response header, which this error does not carry. A 429 whose body has
